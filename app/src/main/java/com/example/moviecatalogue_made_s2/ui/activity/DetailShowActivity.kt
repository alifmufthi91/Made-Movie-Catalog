...
class DetailShowActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        showData = intent.getParcelableExtra<Show>(DETAIL_SHOW)
        showType = intent.getStringExtra(EXTRA_TYPE)
        ...
        favorited = favoritesHelper.isShowFavorited(showData.movieDbId.toString())

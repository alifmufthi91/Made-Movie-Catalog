...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        when(intent.getStringExtra(EXTRA_TYPE)){
            TYPE_RELEASETODAY -> {
                ...
                val call = movieDBClient.getTodayReleases(SHOW_MOVIE.toLowerCase(Locale.getDefault()),
                    ...
                    override fun onResponse(call: Call<ShowList>, response: Response<ShowList>) {
                        ...
                        if (showList != null) {
                            ...
                            for (show in showList.list){
                                showNotification(
                                    context,
                                    context.resources.getString(R.string.today_release_title, show.name),
    ...
    fun setTodayReleaseAlarm(context: Context) {
        ...
        Toast.makeText(context, "tetetete",Toast.LENGTH_SHORT).show()
    }
